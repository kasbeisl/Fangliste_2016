...
namespace Fangliste_2016
{
    partial class Frm_AboutBox : Form
    {
        ...
        {
            if (File.Exists(Properties.Settings.Default.Data + "\\" + "readme.txt"))
            {
                sr = new StreamReader(Properties.Settings.Default.Data + "\\" + "readme.txt", System.Text.Encoding.UTF8, true);
